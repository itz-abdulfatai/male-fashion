        ...
        <div className=" mt-7 flex flex-col items-stretch  gap-y-8">
          ...
          <form action="" className="flex flex-col gap-7">
            ...
            <div className="input-group">
              ...
              <input id="inpt-4" placeholder="Street Address" required type="text" />
              <input  placeholder="Appartment, suite, unite ect (optional)" type="text" />
            </div>
            <div className="input-group">
    ...
    <svg width="18px" height="18px" viewBox="0 0 18 18">
      ...
      <polyline points="1 9 7 14 15 4"></polyline>
              ...
              <div className="input-group">
                ...
                <input id="inpt-12" placeholder="Notes about your order, e.g special notes for delivery" required type="text" />
              </div>
          </form>
        </div>
      </div>
