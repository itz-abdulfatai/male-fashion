        ...
        <div className="text-black flex justify-center items-start">
          <div className="bg-white group-hover:little-shadow -translate-y-10 w-[80%] p-4 flex flex-col items-start gap-3">
            <span className=" text-[#3d3d3d] text-sm ">
              ...
              {new Date(post.timestamps.createdAt).toLocaleDateString("en-GB", {
                day: "2-digit",
                month: "long",
                year: "numeric",
              })}
            ...
            <a
              href=""
              className=" letter-space uppercase text-sm font-bold py-[3px] border-solid border-b-2  border-accent group-hover:border-accent md:border-black"
            >
              read more
            </a>
          </div>
