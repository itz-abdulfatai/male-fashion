  ...
  return (
    <div className=" flex w-full flex-col sm:px-28 px-10 gap-4 padding-y bg-neutral  ">
      ...
      <div className=" flex items-center gap-2">
        <Link to="/" className="text-secondary capitalize ">
          Home
        </Link>
          ...
          <>
            {link == links[links.length - 1] ? (
              <span
                ...
                className={`text-neutral hover:text-primary capitalize transition-all duration-200 ${
                  link === links[index] && "text-primary"
                }`}
              >
                {link}
              </span>
              ...
              <Link
                ...
                className={`text-secondary hover:text-primary capitalize transition-all duration-200 ${
                  link === links[index] && "text-primary"
                }`}
              >
                {link}
